...
if __name__ == "__main__":
    ...
    """
    root = {"lead_time": 3, "holding_cost": 0.3, "penalty_cost": 0.5, "successor": None, "predecessors": [1, 2],
            "number": 0}
    node1 = {"lead_time": 1, "holding_cost": 0.1, "successor": 0, "predecessors": [3, 4], "number": 1}
    node2 = {"lead_time": 3, "holding_cost": 0.3, "successor": 0, "predecessors": [5, 6], "number": 2}
    node3 = {"lead_time": 1, "holding_cost": 0.1, "successor": 1, "predecessors": None, "number": 3}
    ...
    node6 = {"lead_time": 3, "holding_cost": 0.3, "successor": 2, "predecessors": None, "number": 6}
